jQuery(function(e) {
	...
	jQuery(function() {
		...
		jQuery('#horizontal-navtoggle').on("click", function(e) {
			...
			jQuery('.side-navbar').addClass('move-right');
			if((document.querySelector('.side-navbar').classList.contains('move-right'))){
				document.querySelector('.kataloq-open-item').classList.remove('active');
				document.querySelectorAll('.kataloq-inner-item').forEach(inner_item => {
					inner_item.classList.remove('active');
				});
				// document.querySelector('.kataloq-inner-item').classList.remove('active');
			}
		});
		jQuery('.side-navbar .turn-back').on("click", function(e) {
			// jQuery('body').toggleClass('active');
			jQuery('.side-navbar').removeClass('move-right');
		});
